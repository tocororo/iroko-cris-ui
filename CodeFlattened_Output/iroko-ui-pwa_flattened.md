...
/_ src/app/app.component.scss _/
.app-footer {
...
/_ Ensure the main layout uses flexbox properly _/
.flex {
display: flex;
}
...
/_ Global search in mobile menu _/
.mobile-search-menu {
.mat-menu-content {
padding: 0 !important;
...
/_ Fix mat-list-item default padding _/
::ng-deep {
.mat-mdc-list-item {
...
/_ Remove default active background from Angular Material _/
...
return 'No results found.';
    ...
    return `Mostrando ${startIdx}–${endIdx} of ${this.totalCount} elementos — Página ${
      this.currentPage + 1
    } de ${totalPages}`;
...
const start = this.currentPage _ this.pageSize + 1;
const end = Math.min(
(this.currentPage + 1) _ this.pageSize,
this.totalItems
);
...
/_ src/app/pages/\_page-styles.scss _/
.page-container {
max-width: 1200px;
margin: 0 auto;
padding: 24px 16px;
...
/_ Import this in each page component's SCSS file _/
...
/_ src/app/components/generic-list/generic-list.component.scss _/
...
/_ src/app/components/global-search/global-search.component.scss _/
.search-container {
position: relative;
width: 100%;
max-width: 400px;
...
/_ src/app/pages/home/home.component.scss _/
.home-container {
max-width: 1200px;
margin: 0 auto;
padding: 0 16px;
...
"**relation": "id",
"**predicate": "RESEARCH_ACTIVITY_IN",
"**target": "Term",
"id": "id",
"description": "description",
"vocabulary": "vocabulary"
...
/_ src/app/pages/node-view/node-view.component.scss _/
.node-view-page {
max-width: 1200px;
margin: 0 auto;
padding: 24px 16px;
